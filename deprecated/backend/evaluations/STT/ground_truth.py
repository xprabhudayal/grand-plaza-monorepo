...
GROUND_TRUTH_CASES = [
    ...
    GroundTruthCase(
        case_id="clear_001",
        audio_filename="New Recording 1.m4a",
    ...
    GroundTruthCase(
        case_id="clear_002", 
        audio_filename="New Recording 2.m4a",
    ...
    GroundTruthCase(
        case_id="tech_001",
        audio_filename="New Recording 3.m4a", 
    ...
    GroundTruthCase(
        case_id="tech_002",
        audio_filename="New Recording 4.m4a",
    ...
    GroundTruthCase(
        case_id="numbers_001",
        audio_filename="New Recording 5.m4a",
    ...
    GroundTruthCase(
        case_id="names_001",
        audio_filename="New Recording 6.m4a",
    ...
    GroundTruthCase(
        case_id="names_002",
        audio_filename="New Recording 7.m4a",
    ...
    GroundTruthCase(
        case_id="hotel_001",
        audio_filename="New Recording 8.m4a",
    ...
    GroundTruthCase(
        case_id="hotel_002",
        audio_filename="New Recording 9.m4a",
    ...
    GroundTruthCase(
        case_id="hotel_003",
        audio_filename="New Recording 10.m4a",
    ...
    GroundTruthCase(
        case_id="accent_001",
        audio_filename="New Recording 11.m4a",
    ...
    GroundTruthCase(
        case_id="accent_002",
        audio_filename="New Recording 12.m4a",
    ...
    GroundTruthCase(
        case_id="fast_001",
        audio_filename="New Recording 13.m4a",
    ...
    GroundTruthCase(
        case_id="multi_001",
        audio_filename="New Recording 14.m4a",
    ...
    GroundTruthCase(
        case_id="emotion_001",
        audio_filename="New Recording 15.m4a",
    ...
    GroundTruthCase(
        case_id="emotion_002", 
        audio_filename="New Recording 16.m4a",
    ...
    # Noisy Background - Using one of the existing recordings for this
    GroundTruthCase(
        case_id="noisy_001",
        audio_filename="New Recording 17.m4a",
